...
interface IEmpWages {
    void computeEmpWage(EmployeeWage.EmpWageBuilder EmpWageBuilder);
}

public class EmployeeWage implements IEmpWages {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("1:For Zomato");
            System.out.println("2:For Swiggy ");
            System.out.println("3:For Dominoz");
